...
MONGO_DBNAME | the name of the mongo database
MONGO_URI | the URI that connects to mongo
...
- app.py - Code for date in python was retrived from w3schools.com
[www.w3schools.com](https://www.w3schools.com/python/python_datetime.asp)

- app.py -Integer converter retrived from careerkarma.com
[careerkarma.com](https://careerkarma.com/blog/python-string-to-int/)

- reviews.html - Range for jinja was adapted from jinja.palletsprojects.com
...
This project received inspiration for this project from three following websites:
